...
//       <h1 className="text-primary fw-bold">Welcome to Admin Dashboard 🎯</h1>
//     </div>
//   );
// };
...
//             }}
//             onMouseEnter={e => {
//               e.currentTarget.style.background = "linear-gradient(90deg, #64b5f6, #1e88e5)";
...
//           <Row className="g-3">
//             {sampleStocks.map(s => {
//               const price = Number(s.price || 0); // ensure numeric
...
//       if (opt.name === "Users") navigate("/users");
//       if (opt.name === "Accounts") navigate("/account"); // ← ye add kiya
//     }}
//     style={{
//       textDecoration: "none",
//       fontSize: "16px",
